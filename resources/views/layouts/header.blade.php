...
<!--<header id="header">-->
    <div id="logo-group">
        ...
        <span id="logo3" style="color: #fff; width: 70%; display: block; font-size: 20px; font-weight: 300; height: 50px; margin: 10px; padding: 5px; ">Contabilidad</span>
    ...
    <div class="pull-right">
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                ...
                <ul class="dropdown-menu pull-right">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="<?php //echo core::getInstancePath();?>/login/salir" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span> <a href="<?php //echo core::getInstancePath();?>/login/salir" title="Cerrar Session" data-action="userLogout" data-logout-msg="Usted puede mejorar su seguridad aún más después de cerrar la sesión cerrando Este navegador abierto"><i class="fa fa-sign-out"></i></a><span class="hide-phone">Salir</span> </span>
        </div>
        <!-- end logout button -->
